...
import { Search, ListFilter, Plus, Trash2, User } from 'lucide-react';

const ChatList = ({ activeTab, activeChatId, onSelectChat, chats, groups, onAddNew, onDeleteItem }) => {
  const filteredItems = activeTab === 'groups' ? groups : chats;
          ...
          >
            ...
            <div className="flex-1 min-w-0 pr-2">
              <div className="flex justify-between items-center mb-0.5">
                <h3 className="font-semibold text-[15px] truncate text-wa-text-primary">{item.name}</h3>
